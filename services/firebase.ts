...
// FIX: Changed from a namespace import (`* as firebaseApp`) to named imports for the Firebase v9+ modular SDK.
...
try {
  // FIX: Used the imported Firebase functions directly instead of as methods on a namespace.
