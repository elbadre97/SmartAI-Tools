...
export const LoginModal: React.FC<LoginModalProps> = ({ onClose, onLogin, t }) => {
  return (
    ...
    >
      <div 
        className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-xl rounded-2xl p-8 max-w-sm w-full mx-4 shadow-2xl animate-fade-in-up transform transition-all"
        onClick={e => e.stopPropagation()} // Prevent closing modal when clicking inside
      >
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-bold text-gray-800 dark:text-white">{t.login_modal_title}</h2>
        ...
        <p className="text-gray-600 dark:text-gray-300 mb-8 text-center">{t.login_modal_subtitle}</p>
